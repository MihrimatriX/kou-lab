...
int bolenKalan(int numara, string cakismaTipi)
{
	...
	//maksimum 625 olabiliyorsa, 625 e en yakýn asal sayý olarak 631 seçiliyor.
...
int main()
{
	...
	cout << setw(5) << lineerYoklamaBolenKalanAra(kisiler) << " Adimda Lineer Yoklama BolenKalan Yontemiyle Bulunmustur." << endl;//Lineer Yoklama ve Bolen Kalan Kayýt edilen dosyadan tüm kiþiler aranýyor ve ekrana numara isim yazdýrýlýyor.
	Sleep(2000);
	system("cls");
